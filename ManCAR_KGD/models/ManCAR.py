...
import utils.layers_mancar as layers_mancar
import utils.wrappers_mancar as wrappers_mancar
...
class ManCAR(AdaptivePromptingModel):
    ...
    def parse_model_args(parser):
        ...
        parser.add_argument(
            ...
            type=int, 
            default=300, 
            help="Size of inner hidden layers"
        )
        parser.add_argument(
            "--dropout",
            type=float,
    ...
    def _define_params(self, corpus):
        ...
        self.trm_encoder = layers_mancar.TransformerBlockv2(
        ...
        self.model = wrappers_mancar.PromptReaRecBertWrapper(
