...
class PromptingModel(BaseModel):
    ...
    def parse_model_args(parser):
        ...
        parser.add_argument(
            ...
            type=int,
            default=4,
            help="Number of trigger items for Swing neighbors, used in train",
        )
        parser.add_argument(
            "--item_per_trigger_train",
            type=int,
            default=7,
            help="Number of items/trigger for Swing neighbors, used in train",
        )
        return parser
