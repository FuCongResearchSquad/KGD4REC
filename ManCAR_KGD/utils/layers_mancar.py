...
class CasualTransformerEncoder(nn.Module):
    """
    CasualTransformerEncoder is a wrapper for GPT-based transformer model to generate sequence.

    Args:
        transformer (nn.Module): the GPT-based transformer model
    ...
    def __init__(self, transformer, hidden_size, dropout, rms_norm_eps=1e-12):
        super(CasualTransformerEncoder, self).__init__()
